...
## ⚙️ Funcionalidades
- ✅ **Adicionar Material**: Registar novos materiais no stock com uma quantidade inicial.
- ✅ **Consultar Stock**: Verificar a quantidade disponível de um material específico.
- ✅ **Atualizar Stock**:  
  - Adicionar unidades ao stock  
  - Remover unidades do stock (com validação)
- ✅ **Exibir Stock Geral**: Mostrar todos os materiais e respetivas quantidades.
- ✅ **Exportar Stock**: Guardar os dados do stock num ficheiro `.csv`.
